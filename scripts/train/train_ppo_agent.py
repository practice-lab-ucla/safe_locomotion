...
env = make_gym_environment(
    task="Safe-Locomotion-Base-v0", num_envs=2048, headless=True
)
...
models = {}
models["policy"] = StochasticActorMLP(env.observation_space, env.action_space, device, elementwise_affine=True)
